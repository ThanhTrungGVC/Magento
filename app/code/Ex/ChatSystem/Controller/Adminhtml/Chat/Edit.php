...
class Edit extends \Ex\ChatSystem\Controller\Adminhtml\Chat
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Ex_ChatSystem::chat_edit');
    }
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Ex\ChatSystem\Model\Chat');
        ...
        $this->_coreRegistry->register('exchatsystem_chat', $model);
