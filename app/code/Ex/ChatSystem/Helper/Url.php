...
namespace Ex\ChatSystem\Helper;
...
class Url extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const ROUTE_ACCOUNT_LOGIN = 'exchatsystem/customer/login';
    ...
    public function getDashboardUrl() {
         ...
         */
        return $this->urlBuilder->getUrl ( 'exchatsystem/customer/dashboard' );
    }
    ...
    public function getRegisterUrl() {
         ...
         */
        return $this->urlBuilder->getUrl ( 'exchatsystem/customer/create' );
    }
    ...
    public function getRegisterPostUrl() {
         ...
         */
        return $this->urlBuilder->getUrl ( 'exchatsystem/customer/createpost' );
    }
